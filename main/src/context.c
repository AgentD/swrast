                           ...
                           unsigned int width, unsigned int height )
{
    ...
    if( ctx->draw_area.maxx < 0 ) ctx->draw_area.maxx = 0;
    if( ctx->draw_area.maxy < 0 ) ctx->draw_area.maxy = 0;
    if( ctx->draw_area.minx < 0 ) ctx->draw_area.minx = 0;
    if( ctx->draw_area.miny < 0 ) ctx->draw_area.miny = 0;
